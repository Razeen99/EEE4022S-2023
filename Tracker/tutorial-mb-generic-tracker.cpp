...
int main(int argc, char **argv)
{
  ...
  try {
    ...
    cam.initPersProjWithoutDistortion(3059, 3068, 1991, 895);
    //! [Set camera parameters]
    ...
    std::cout << tracker.getOptimizationMethod() << std::endl;

    std::cout << "cMo: " << std::endl;
    // std::cout << tracker.getPose() << std::endl;
    std::cout << tracker.getPose() << std::endl;
    std::cout << cMo << std::endl;
    std::cout << "rotate:" << std::endl;
    // std::cout << cMo.getRotationMatrix() << std::endl;
    // std::cout << "thetaU:" << std::endl;
    std::cout << cMo.getThetaUVector() << std::endl;
    std::cout << "translate:" << std::endl;
    std::cout << cMo.getTranslationVector() << std::endl;
